...
WaveSurfer.util.extend(WaveSurfer.Drawer.Canvas, {
	...
	console.log('inside drawWave channelIndex:' + channelIndex);
        // Split channels
        if (peaks[0] instanceof Array) {
            var channels = peaks;
            if (this.params.splitChannels) {
	...
	console.log('inside drawWave length: ' + length + ' width:' + this.width + ' scale:' + scale);	
